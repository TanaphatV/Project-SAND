...
bool initGL()
{
    ...
    {
      "#version 330\n in vec2 LVertexPos2D; in vec3 vColor;  out vec3 color; void main() { gl_Position = vec4( LVertexPos2D.x, LVertexPos2D.y, 0, 1 ); color = vColor; }"
    };
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    glVertexAttribPointer(gVColorLocation, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat), NULL);
